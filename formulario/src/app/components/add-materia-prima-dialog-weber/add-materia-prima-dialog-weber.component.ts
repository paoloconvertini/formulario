...
@Component({
  ...
  templateUrl: './add-materia-prima-dialog-weber.component.html',
  styleUrls: ['./add-materia-prima-dialog-weber.component.css']
})
export class AddMateriaPrimaDialogWeberComponent extends CommonListComponent implements OnInit{
  ...
  constructor(private dialogRef: MatDialogRef<AddMateriaPrimaDialogWeberComponent>, private service: MateriePrimeWeberService) {
    super();
  }
